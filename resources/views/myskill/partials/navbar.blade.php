<nav id="navbar"
    ...
    <a class="text-2xl font-bold leading-none" href="#">
        <img loading="lazy" class="max-w-20 max-sm:mx-0 max-md:w-20 mx-10 h-auto" src="{{ asset('assets/logo.png') }}" alt="logo-company">
    </a>
    <div class="lg:hidden">
                ...
                <div @click="open = !open" class="relative py-1"
                    ...
                    <div class="flex justify-center items-center space-x-3 cursor-pointer">
                        <div class="w-12 h-12 rounded-full overflow-hidden border-2 border-gray-900">
                            <img loading="lazy" src="{{ Auth::user()->foto ? asset('./foto_user/' . Auth::user()->foto) : './foto_user/blank.png' }}"
    ...
    <nav
        ...
        <div class="flex items-center mb-8">
            <a class="mr-auto text-3xl font-bold leading-none hover:text-green-600" href="#">
                <img loading="lazy" class="w-20" src="{{ asset('assets/logo.png') }}" alt="logo-company">
            </a>
