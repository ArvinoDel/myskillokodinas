...
<div class="container mx-auto">
    <div class="flex items-center bg-pink-200 p-6">
        <!-- Image Section -->
        <div class="w-96">
            <img loading="lazy" src="{{ asset('./assets/bootcamp/hero-header.png') }}"
                class="h-72 w-100 lg:ml-20 mx-auto py-4" />
        </div>
        <!-- Text Section -->
        <div class="w-1/2 pl-8">
            <h1 class="text-4xl font-bold text-orange-500">
                <span class="text-black">BOOTCAMP</span> PANDAI DIGITAL
            </h1>
            <p class="mt-4 text-lg text-gray-700">
                Bebas konsultasi dan tanya jawab dengan Master Tutor!
            </p>
            <button
                class="mt-6 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg flex items-center">
                Lihat Jadwal
            </button>
        </div>
    </div>
        ...
        <div class="container mx-auto p-4">
            ...
            <div id="tutorList" class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white shadow-lg rounded-lg p-4 flex items-center space-x-4 tutor-card"
                    data-name="M. Nurwahyu Al Risqi">
                    <img class="w-16 h-16 rounded-full" src="https://via.placeholder.com/150" alt="Tutor 1" />
                    <div>
                        <h2 class="text-xl font-bold">M. Nurwahyu Al Risqi</h2>
                        <p class="text-gray-500">Politeknik Keuangan Negara STAN</p>
                    </div>
                </div>
                <!-- Card 2 -->
                <div class="bg-white shadow-lg rounded-lg p-4 flex items-center space-x-4 tutor-card"
                    data-name="Rahmi Puti Cahyani">
                    <img class="w-16 h-16 rounded-full" src="https://via.placeholder.com/150" alt="Tutor 2" />
                    <div>
                        <h2 class="text-xl font-bold">Rahmi Puti Cahyani</h2>
                        <p class="text-gray-500">Institut Teknologi Bandung</p>
                    </div>
                </div>
                <!-- Card 3 -->
                <div class="bg-white shadow-lg rounded-lg p-4 flex items-center space-x-4 tutor-card"
            ...
            <div class="flex justify-between items-center mt-4">
                <button class="flex items-center px-4 py-2 bg-gray-200 text-gray-600 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
                        ...
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1.707-7.707a1 1 0 010-1.414l3-3a1 1 0 111.414 1.414L10.414 10l2.293 2.293a1 1 0 01-1.414 1.414l-3-3z"
                            clip-rule="evenodd" />
                    </svg>
                    Prev
                </button>
                ...
                <button class="flex items-center px-4 py-2 bg-gray-200 text-gray-600 rounded-lg">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1.707-7.707a1 1 0 000 1.414l-3 3a1 1 0 001.414 1.414L9.586 10l-2.293 2.293a1 1 0 001.414 1.414l3-3a1 1 0 00-1.414-1.414L10 9.586 7.707 7.293z"
                            clip-rule="evenodd" />
                    </svg>
                </button>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="border rounded-lg shadow-sm overflow-hidden">
                ...
                <div id="dropdown-1" class="hidden px-6 py-4 bg-gray-100 text-gray-700">
                    Konten jawaban untuk pertanyaan kedua.
                </div>
            </div>
            ...
            <div class="border rounded-lg shadow-sm overflow-hidden">
                ...
                <div id="dropdown-3" class="hidden px-6 py-4 bg-gray-100 text-gray-700">
                    Konten jawaban untuk pertanyaan ketiga.
                </div>
            </div>
            ...
            <div class="border rounded-lg shadow-sm overflow-hidden">
                ...
                <div id="dropdown-4" class="hidden px-6 py-4 bg-gray-100 text-gray-700">
                    Konten jawaban untuk pertanyaan keempat.
                </div>
            </div>
            ...
            <div class="border rounded-lg shadow-sm overflow-hidden">
                ...
                <div id="dropdown-5" class="hidden px-6 py-4 bg-gray-100 text-gray-700">
                    Konten jawaban untuk pertanyaan kelima.
                </div>
            </div>
            ...
            <div class="border rounded-lg shadow-sm overflow-hidden">
                ...
                <div id="dropdown-6" class="hidden px-6 py-4 bg-gray-100 text-gray-700">
                    Konten jawaban untuk pertanyaan keenam.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex ">
        ...
        <div class="flex-1 lg:p-8 max-sm:p-2">
            <p id="tentang-bootcamp"
                class="text-orange-600 lg:ml-4 lg:text-xl max-sm:text-base max-sm:ml-2 font-bold md:text-xl md:mt-4">
            ...
            <div name="scrollbar-2 mb-4">
                <div class="flex overflow-x-auto space-x-4 no-scrollbar">
                    ...
                    <img src="{{ asset('./assets/bootcamp/get2.png') }}"
                        class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                    <img src="{{ asset('./assets/bootcamp/get3.png') }}"
                        class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                    <img src="{{ asset('./assets/bootcamp/get2.png') }}"
            ...
            <span><br>
                ...
                <div class="border border-gray-300 rounded mt-2 md:m-4">
                    <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center"
                        ...
                        <p class="font-semibold"> Saya tidak memiliki pengalaman sama sekali di bidang Digital
                            Marketing,
