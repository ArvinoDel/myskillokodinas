        ...
        <section
            ...
            <div class="lg:ml-4 max-sm:text-black max-sm:w-full max-sm:text-center max-sm:mx-auto max-sm:py-4"
                ...
                <p
                    ...
                    {{ $bootcamp->judul_bootcamp }}</p>

                <br>
                <div
                    class="lg:w-48 lg:h-36 lg:ml-4 md:w-56 md:h-34 md:ml-4 max-sm:mb-1 bg-white border border-gray-400 lg:rounded-2xl md:rounded-xl shadow relative">
                    <p class="font-bold text-orange-600 text-2xl lg:ml-4 lg:mt-2 md:ml-2 md:text-lg">Batch
                        {{ $bootcamp->sesi }}</p>
                    <p class="text-black font-regular text-xl lg:ml-4 md:ml-2 md:text-base">Rp. {{ $bootcamp->harga }}</p>
        ...
        <div class="flex-1 lg:p-8 max-sm:p-2">
            ...
            <div class="border border-gray-300 rounded mt-2 md:m-4">
                ...
                <div id="faq4"
                    ...
                    project yang dikerjakan terbukti MySkill sudah membantu banyak alumni dalam mencari pekerjaan. </div>
            </div>
            <!-- FAQ 5 -->
            <div class="border border-gray-300 rounded mt-2 md:m-4">
                <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center max-sm:text-xs"
            ...
            <a href="/payment">
                <p
                    class="md:ml-6 md:text-xl text-orange-600 lg:text-xl max-sm:text-base max-sm:ml-2 lg:mt-6 font-bold lg:mb-1 max-sm:mt-4">
