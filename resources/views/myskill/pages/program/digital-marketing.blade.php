...
<div class="digital-marketing">
    <section
        ...
        <img loading="lazy" src="{{ asset('./thumbnail_bootcamp/' . $bootcamp->thumbnail) }}"
...
<div class="flex ">
    ...
    <div class="flex-1 lg:p-8 max-sm:p-2">
        ...
        <br>
        <img loading="lazy" src="{{ asset('./assets/bootcamp/adv.png') }}"
        ...
        <div class="max-sm:hidden md:hidden">
            ...
            <div class="flex overflow-x-auto space-x-4 no-scrollbar">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motivasi.png') }}"
                    class="lg:h-64 max-sm:h-44 lg:w-auto object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motivasi2.png') }}"
                    class="lg:h-64 max-sm:h-44 lg:w-auto object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motivasi.png') }}"
                    class="lg:h-64 max-sm:h-44 lg:w-auto object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motivasi2.png') }}"
        ...
        <div class="lg:hidden">
            ...
            <div class="flex overflow-x-auto space-x-4 no-scrollbar">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motiv1.png') }}" class="max-sm:w-96 object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motif2.png') }}" class="max-sm:w-96 object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motiv1.png') }}" class="max-sm:w-96 object-fill">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/motif2.png') }}" class="max-sm:w-96 object-fill">
            </div>
        </div>
        ...
        <div>
            ...
            <p class="lg:mt-4 sm:mt-2 ml-2 max-sm:mb-1 lg:text-base max-sm:text-sm md:ml-6">
                Pandai Digital percaya, kamu pun bisa belajar dari nol dan rintis karir impianmu meski awalnya terasa
                sulit.
        ...
        <div>
            <img loading="lazy" src="{{ asset('./assets/bootcamp/trusted.png') }}"
        ...
        <img loading="lazy" src="{{ asset('./assets/bootcamp/get.png') }}"
        ...
        <div name="scrollbar-2 mb-4">
            <div class="flex overflow-x-auto space-x-4 no-scrollbar">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/get3.png') }}" class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/get2.png') }}" class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/get3.png') }}" class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/get2.png') }}" class="h-64 w-auto max-sm:w-64 max-sm:h-32">
                <img loading="lazy" src="{{ asset('./assets/bootcamp/get3.png') }}" class="h-64 w-auto max-sm:w-64 max-sm:h-32">
            </div>
        ...
        <span><br>
            ...
            <img loading="lazy" src="{{ asset('./assets/bootcamp/sertifikat.png') }}"
                class="lg:h-80 rounded-3xl w-full lg:w-auto lg:mt-4 lg:ml-2 py-2 max-sm:w-full max-sm:h-auto max-sm:mx-auto max-sm:my-4 object-cover md:p-4">
            <!-- benefit end -->
            ...
            <img loading="lazy" src="{{ asset('./assets/bootcamp/peserta.png') }}"
                class="lg:h-80 rounded-3xl w-full lg:w-auto lg:mt-4 lg:ml-2 py-2 max-sm:w-full max-sm:h-auto max-sm:mx-auto max-sm:my-4 object-cover md:p-4">
            <!-- Kurikulum & Silabus -->
            <p id="kurikulum"
            ...
            <img loading="lazy" class="MuiBox-root mui-style-nj2azm md:p-4"
            ...
            <div class="border border-gray-300 rounded mt-2 md:m-4">
                ...
                <div id="faq4"
                    ...
                    project yang dikerjakan terbukti Pandai Digital sudah membantu banyak alumni dalam mencari pekerjaan.
                </div>
            </div>
            <!-- FAQ 5 -->
            <div class="border border-gray-300 rounded mt-2 md:m-4">
            ...
            <div name="scrollbar-2 mb-8 ">
                <div class="flex overflow-x-auto space-x-4 max-sm:ps-2 no-scrollbar">
                    <img loading="lazy" src="{{ asset('./assets/bootcamp/komun1.png') }}"
                        class="lg:h-64 lg:w-auto max-sm:w-64 max-sm:h-32 md:p-4">
                    <img loading="lazy" src="{{ asset('./assets/bootcamp/komun2.png') }}"
                        class="lg:h-64 lg:w-auto max-sm:w-64 max-sm:h-32 md:p-4">
                    <img loading="lazy" src="{{ asset('./assets/bootcamp/komun3.png') }}"
                        class="lg:h-64 lg:w-auto max-sm:w-64 max-sm:h-32 md:p-4">
                    <img loading="lazy" src="{{ asset('./assets/bootcamp/komun4.png') }}"
                        class="lg:h-64 lg:w-auto max-sm:w-64 max-sm:h-32 md:p-4">
                </div>
            </div>
            <!-- komunitas end -->
    ...
    <div class="flex space-x-4 w-max lg:px-12 max-sm:px-4 py-3">
        ...
        <a href="/bootcamp/digital-marketing/{{ $bootcampp->id_bootcamp }}">
            <div
                ...
                <img loading="lazy" src="{{ asset('./thumbnail_bootcamp/' . $bootcampp->thumbnail) }}"
                    class="h-auto max-h-36 w-full rounded-sm object-contain mb-2">
                <p class="mt-2 text-gray-700 font-semibold font-sans lg:text-lg max-sm:text-base max-sm:truncate">
                    {{ $bootcampp->judul_bootcamp }}
                </p>
                <div class="flex flex-col mt-2 text-gray-500">
                    @foreach ($bootcampp->batch as $batch)
                    <div class="flex items-center">
                        <i class="fas fa-calendar-alt mr-2"></i>
                        <p class="text-sm">{{ $batch->tanggal_mulai }}</p>
                    </div>
                    @endforeach
                    <div class="flex items-center">
                        <i class="fas fa-tag mr-2"></i>
                        <p class="text-sm">Rp {{ number_format($bootcampp->harga_diskon, 0, ',', '.') }} <span
                                class="line-through text-red-500 max-sm:hidden">Rp
                                {{ number_format($bootcampp->harga, 0, ',', '.') }}</span></p>
                    </div>
                </div>
            </div>
        </a>
