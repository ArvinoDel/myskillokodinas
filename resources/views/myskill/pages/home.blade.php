...
@section('container')
        ...
        <div class="w-44 h-64 md:w-52 md:h-64 bg-white border border-black rounded-2xl shadow flex-shrink-0">
            <div class="flex justify-center">
                ...
                @foreach ($testimonis as $testimoni)
                    <img class="flex justify-center mt-4 rounded-t-lg w-28 h-28"
                        src="{{ url('foto_testimoni/' . $testimoni->gambar) }} }}" alt="" />
                @endforeach
            </div>
    ...
    <div class="grid md:grid-cols-2 lg:py-10">
        <img class="lg:w-96 w-80 h-80 ms-10 lg:ms-48 max-sm:ms-auto" src="{{ asset('assets/home/image1.svg') }}"
            alt="" />
    ...
    <div class="grid md:grid-cols-2 md:py-10">
        <img class="ms-10 w-80 lg:w-96 h-80 lg:ps-20 max-sm:ms-auto" src="{{ asset('assets/home/image3.svg') }}"
            alt="" />
        <div class="text-start px-10 lg:px-20  lg:py-4">
        ...
        <div class="text-start px-12 lg:px-20 lg:py-4">
            ...
            <div class="grid grid-cols-2 gap-4 text-center">
                <a href="/corporate-service"
                    class="font-semibold rounded-xl  mt-4 max-sm:text-left px-5 py-2.5 bg-orange-400 ">Corporate
                    Service</a>
                <a href="/experience" class="font-semibold px-5 py-2.5 rounded-xl  mt-4 bg-orange-400 ">Sofware HRIS</a>
            </div>
        </div>
        <img class="lg:w-96 w-80 h-80 ms-10 max-sm:ms-auto" src="{{ asset('assets/home/image88.svg') }}"
            alt="" />
    </div>
    <h2 class="text-center font-bold text-2xl mx-3 lg:px-80 py-24">Rasanya Gabung Dengan Komunitas GM Official #Sipaling
        Ngoding
    </h2>
    <div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-4 md:gap-8 lg:gap-11"
        style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')"
        ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')"
        onmouseup="this.classList.remove('touching')">
        @foreach ($album as $album)
            <div
                class="snap-always snap-center flex-shrink-0 sm:w-40 sm:h-32 md:w-52 md:h-44 lg:w-80 lg:h-48 bg-gradient-to-b from-orange-400 to-red-500 border rounded-lg">
                <img class="w-full h-2/3 object-cover rounded-xl p-2" src="{{ asset('img_album/' . $album->gbr_album) }}"
                    alt="Album Image" />
                <div class="p-2">
                    <h5 class="text-sm md:text-lg font-semibold text-white text-center py-2">Main di Perusahaan</h5>
                </div>
            </div>
        @endforeach
    </div>
    ...
    <div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-5 lg:gap-11"
        ...
        <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
            <img class="flex justify-center mx-auto mt-4 w-16" src="{{ asset('assets/home/aws.svg') }}"
                alt="" />
        </div>
        <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
    ...
    <div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-5 lg:gap-11"
        ...
        <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
            <img class="flex justify-center mx-auto mt-9 w-28" src="{{ asset('assets/home/idn.svg') }}"
                alt="" />
        </div>
        <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
            <img class="flex justify-center mt-6 mx-auto w-40" src="{{ asset('assets/home/cnbc.svg') }}"
                alt="" />
        </div>
        <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
