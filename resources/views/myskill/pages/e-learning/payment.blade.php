            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-8 px-4 border-b mb-4 pb-4">
                    ...
                    <div class="flex items-center mb-6 flex-col sm:flex-row max-sm:items-start">
                        <img loading="lazy" src="{{ asset('assets/corporate/course-report.webp') }}" alt="Course Report"
                        ...
                        <div class="flex items-center ml-2 mt-2 sm:mt-0">
                            <img loading="lazy" src="{{ asset('./assets/bootcamp/hero-header.png') }}" alt="Course Report"
                    ...
                    <div class="overflow-x-scroll no-scrollbar">
                        <div class="flex space-x-4">
                            <div
                                ...
                                <img loading="lazy" src="{{ asset('foto_user/1726534293_avatar5.png') }}" alt="Paksi Cahyo Baskoro"
                            ...
                            <div
                                class="flex-shrink-0 flex items-center p-4 bg-white rounded-lg shadow w-[300px] my-1 ml-2">
                                <img loading="lazy" src="{{ asset('foto_user/1726534293_avatar5.png') }}" alt="M. Arkhan Doohan"
                                    class="rounded-lg mr-4 max-w-[60px]">
                                <div>
    ...
    <div id="paymentModal"
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                <img loading="lazy" src="{{ asset('assets/logo.png') }}" class="w-32 md:w-24" alt="Logo">
            ...
            <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex justify-center mb-4">
                    <img loading="lazy" src="{{ asset('/foto_pembayaran/' . $met->pembayaran) }}" alt="paymentImage"
