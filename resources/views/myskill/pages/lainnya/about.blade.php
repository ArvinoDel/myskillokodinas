        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-wrap gap-6 mb-10">
                <div class="flex-1">
                    ...
                    <div class="flex gap-4 items-center">
                        <img src="{{ asset('./foto_metode/startup.svg') }}" alt="LinkedIn Top Startup"
                            class="w-full h-full rounded-full object-cover">
                        <img src="{{ asset('./foto_metode/techinasia.svg') }}" alt="AWS EdStart Member"
                            class="w-full h-full rounded-full object-cover">
                        <img src="{{ asset('./foto_metode/technode.svg') }}" alt="Partner Logo"
                            class="w-full h-full rounded-full object-cover">
                    </div>
                </div>
                <div class="flex-1">
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center gap-6">
                    <div
                        class="bg-gradient-to-r from-teal-400 via-blue-500 to-purple-500 p-8 rounded-2xl text-white text-center">
